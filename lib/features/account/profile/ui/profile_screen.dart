              ...
              ProfileUserBranchWidget(
                items: [
                  ProfileMenuItemData(
                    ...
                    onTap: () {
                      context.pushNamed(Routes.branchContactScreen);
                    },
                  ),
                ],
              ),
              ...
              ProfileUserBranchWidget(
                items: [
                  ProfileMenuItemData(
                    ...
                    onTap: () {
                      context.pushNamed(Routes.helpQuestionsScreen);
                    },
                  ),
                  ProfileMenuItemData(
                    ...
                    onTap: () {
                      context.pushNamed(Routes.contactManagerScreen);
                    },
                  ),
                  ProfileMenuItemData(
                    title: 'Report a Bug',
                    ...
                    onTap: () {
                      context.pushNamed(Routes.reportBugScreen);
                    },
                  ),
                ],
              ),
