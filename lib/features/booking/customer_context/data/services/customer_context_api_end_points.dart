...
class CustomerContextApiEndPoints {
  static String context(String customerUuid) {
    return '${EndPoints.baseUrl}/employee/customers/$customerUuid/context';
  }

  static String packages(String customerUuid) {
    return '${EndPoints.baseUrl}/employee/customers/$customerUuid/packages';
  }

  static String followUps(String customerUuid) {
    return '${EndPoints.baseUrl}/employee/customers/$customerUuid/follow-ups';
  }
}
