...
class MyReviewsService {
  ...
  MyReviewsService({required this.apiConsumer});
  ...
  Future<MyReviewsResponseModel> getReviews({
    ...
    final response = await apiConsumer.get(
      '${EndPoints.baseUrl}${MyReviewsApiEndPoints.ratings(rating: rating, bookingUuid: bookingUuid, fromDate: fromDate, toDate: toDate, active: active, page: page, perPage: perPage)}',
